...
car_per_year_df = car_data['model_year'].value_counts().sort_values().reset_index()
...
precios_filtrados = car_data[(car_data["price"] >= precio_min) & (car_data["price"] <= precio_max)]
